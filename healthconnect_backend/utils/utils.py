...
def extracting_diseases_from_posts():
    ...
    common_disease_names = [
        ...
        "non-melanoma",
        "Skin rashes",
        "Slapped cheek syndrome" "Soft tissue sarcomas",
        "Sore throat",
        "Stillbirth",
        "Stomach ache",
        "abdominal pain",
        ...
        "strep A" "Stress",
        "anxiety",
        "low mood" "Sudden infant death syndrome" "SIDS",
        "Suicide",
        "Sunburn",
    ...
    df = pd.DataFrame(common_disease_names,columns=['common_diseases'])
    #print(df.head())

    post = " I have been feeling headache and ulcer for a week now, do i have cancer ?"

    def word_matcher(text, word_list):
        matches = set()  
    ...
    # Find matches
    matched_diseases = word_matcher(post, df['common_diseases'])

    print("Possible diseases mentioned:", matched_diseases)
